    ...
    return (
        <div className="lg:mx-4 lg:my-4 lg:ml-20 lg:mt-20 p-2 lg:p-12">
            <div>
                ...
                <h2 className="text-3xl font-thin mt-6">React - Next.js - Typescript - shadcn/ui - TailwindCSS - Framer Motion...</h2>
            </div>
            ...
            <div>
                ...
                <h2 className="text-3xl font-thin mt-6">Base de datos, Autenticación, E-commerce...</h2>
            </div>
